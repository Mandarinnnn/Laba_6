...
public:
    ...
    bool Init()
    {
		...
		if (!m_quad.LoadMesh("D:/Content/quad.obj")) {
            return false;
        }
		...
		if (!m_mesh.LoadMesh("D:/Content/phoenix_ugv.md2")) {
			return false;
		}
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "Lesson 42")) {
        return 1;
    }
