...
public:
    ...
    bool Init()
    {
        ...
        if (!m_mesh.LoadMesh("D:/Content/boblampclean.md5mesh")) {
        ...
        if (!m_quad.LoadMesh("D:/Content/quad_r.obj")) {
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, false, "Lesson 41")) {
        return 1;
    }
